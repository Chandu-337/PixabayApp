...
// const Navbar = () => {
//   return (
//     <nav className="pixnav">
//       <div className="pnav_img">
...
//       </div>
//       <div className="pnav_list">
//         <ul>
//           <li><button id="explore">Explore</button></li>
//           <li><i class="fa-solid fa-bell"></i></li>
//           <li><div id="round"></div></li>
//           <li><button id="upload"><i class="fa-solid fa-upload"></i>Upload</button></li>
